...
//     })
// }
// calcAverageHumanAge([16,6,10,5,1,4])
...
// const swimmingAdjacent = breeds.find(breed => breed.activities.includes('swimming').flatMap(breed => breed.activities).filter(activity => activity !== 'swimming'))
// console.log(new Set(swimmingAdjacent))

console.log(breeds.every(breed => breed.averageWeight > 10))
console.log(breeds.some(breed => breed.activities.length >= 3))

const fetchBOnous = (breeds.filter(breed => breed.activities.includes('fetch')).map(breed => breed.averageWeight))
